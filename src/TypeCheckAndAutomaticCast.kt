...
//    println("'$obj' string lenght is ${getStringLength(obj)}?:... error,is empty or not a string at all")
//    println("'$obj' string lenth is ${getStringLength_2(obj) ?: "... err, is empty or not a string at all"}")
